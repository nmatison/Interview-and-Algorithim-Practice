...
// Your explanation:
// You need to check to see if the object being passed in has the same name property as amy and not if the two
// objects are equal. Every time you create a new object in JS it will point to a different memory slot.
...
// I want this fu.nction to set 4 Timeouts, and after 0 seconds
